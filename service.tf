...
moved {
  from = aws_s3_bucket.another_bucket
  to = module.main.aws_s3_bucket.another_bucket
}

moved {
  from = aws_s3_bucket.the-accounts
  to = module.main.aws_s3_bucket.the-accounts
}

moved {
  from = aws_vpc.main
  to = module.main.aws_vpc.main
}
